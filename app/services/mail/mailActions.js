...
const {
  ...
  DELETE_MAIL: (user, messageFolder, messageObject, afterDeletionCallback) => ({user, messageFolder, messageObject , afterDeletionCallback}),
  MAIL_SET_READ: (user, messageFolder, messageUUID, afterSetCallback) => ({user, messageFolder, messageUUID, afterSetCallback})
});
