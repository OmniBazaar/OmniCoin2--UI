...
const {
  ...
  LOAD_FOLDER: (myUsername, messageFolder) => ({myUsername, messageFolder}),
  ...
  MAIL_SET_READ: (messageFolder, messageUUID, afterSetCallback) => ({messageFolder, messageUUID, afterSetCallback})
});
