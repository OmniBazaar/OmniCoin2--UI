...
class MyListingsHighestTable extends Component {
  componentDidMount() {
    this.props.listingActions.getMyListingsHighest(this.props.myListings);
    this.props.listingActions.setPaginationMyListingsHighest(3 * 6);
  }

  componentWillReceiveProps(nextProps) {
    if (this.props.myListings !== nextProps.myListings) {
      this.props.listingActions.getMyListingsHighest(nextProps.myListings);
      this.props.listingActions.setPaginationMyListingsHighest(3 * 6);
    }
  }
  ...
  handlePaginationChange = (e, { activePage }) => {
    this.props.listingActions.setActivePageMyListingsHighest(activePage);
  };
  ...
  render() {
    ...
    const rows = _.chunk(myListingsHighestFiltered, 6);
      ...
      <div className="data-table">
        ...
        <div className="top-detail bottom">
          <div className="pagination-container">
            <Pagination
              activePage={activePageMyListingsHighest}
              boundaryRange={1}
              onPageChange={this.handlePaginationChange}
              size="mini"
              siblingRange={1}
              totalPages={totalPagesMyListingsHighest}
...
MyListingsHighestTable.propTypes = {
  listingActions: PropTypes.shape({
    getMyListingsHighest: PropTypes.func,
    setPaginationMyListingsHighest: PropTypes.func,
    setActivePageMyListingsHighest: PropTypes.func,
  }),
  listing: PropTypes.shape({
    activePageMyListingsHighest: PropTypes.number,
    totalPagesMyListingsHighest: PropTypes.number,
    myListingsHighestFiltered: PropTypes.array,
  }),
...
MyListingsHighestTable.defaultProps = {
  listingActions: {},
  listing: {},
  myListings: [],
  tableProps: {},
...
)(injectIntl(MyListingsHighestTable));
